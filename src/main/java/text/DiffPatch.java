...
public class DiffPatch {
    ...
    public int diff_commonPrefix(String text1, String text2) {
        ...
        for (int i = 0; i < n; i++) {
            if (text1.charAt(i) != text2.charAt(i)) {
                /*
                for ( int k=6; k>-4; k--)
                    System.out.println(i+" "+text1.charAt( i - k )+" "+ ((int) text1.charAt( i - k )) +" "+ text2.charAt( i - k ) + " " + ((int) text2.charAt
                    ( i - k )) );
                 */
                return i;
            }
    ...
    public static class Diff implements Serializable {
        ...
        public int hashCode() {
            ...
            result += prime * ((text == null) ? 0 : FolderDiff.cleanCodeReformat(text).hashCode());
            return result;
        }
        ...
        public boolean equals(Object obj) {
            ...
            } else if (!FolderDiff.cleanCodeReformat(text).equals(FolderDiff.cleanCodeReformat(other.text))) {
                return false;
            }
            return true;
        }
